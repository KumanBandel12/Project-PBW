...
function deleteTujuan($db, $data, $user_id) {
    try {
        ...
        // Ambil data tujuan sebelum dihapus
        ...
        if($select_stmt->rowCount() > 0) {
            ...
            // Ambil juga data subtujuan terkait
            ...
            // Siapkan data asli untuk disimpan dalam format JSON
            $data_asli = [
                ...
                'subtujuan' => $subtujuan_data // Simpan data subtujuan juga
            ];

            // Masukkan ke tabel Sampah
