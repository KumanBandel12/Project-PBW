    ...
    try {
        ...
        while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            $catatan_item = array(
                ...
                "isPinned" => (bool)($row['is_pinned'] ?? false), // Mengambil nilai is_pinned jika ada, default false
                "createdAt" => $row['dates'] . 'T00:00:00.000Z', // Asumsi tanggal dibuat sama dengan tanggal di DB
                "updatedAt" => ($row['updated_at'] ?? $row['dates']) . 'T00:00:00.000Z' // Gunakan updated_at jika ada
            );
